  ...
  return (
    <Router>
      ...
      <Routes>
        ...
        <Route path="/dailyactivity" element={isLoggedIn ? <DailyActivity /> : <Navigate to="/login" />} />
        <Route path="/messages" element={isLoggedIn ? <Messages /> : <Navigate to="/login" />} />
        <Route path="/workouts" element={isLoggedIn ? <Workouts /> : <Navigate to="/login" />} />
        <Route path="/clientcoaches" element={isLoggedIn ? <ClientCoaches /> : <Navigate to="/login" />} />
